...
grid = [[0x13, 0x92, 0x49, 0xEC],
[0xBD, 0x31, 0xE8, 0xFF],
[0x09, 0xDD, 0xBE, 0xDE],
[0xC9, 0x5A, 0x1D, 0x36]]

grid = [[0xBC, 0xE6, 0x56, 0x29, 0x99, 0x95, 0xAE, 0x27, 0x9F, 0x89, 0x88, 0x8F, 0xBC, 0xB4, 0x2A, 0x71, 0x44, 0x7F, 0xAF, 0x96],
...
m.maximize(m.sum(x[(r,c)]*(grid[r][c]-128) for r in rows for c in cols))
m.solve(log_output = True)

print(sum(x[(r,c)].solution_value*(grid[r][c]-128) for r in rows for c in cols))
solution = []
